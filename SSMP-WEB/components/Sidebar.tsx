...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside
        className={`
          flex-col justify-between p-4 bg-white dark:bg-background-dark border-r border-[#f3e7ea] dark:border-[#3a2228]
                ...
                return (
                  <div
                    ...
                    onClick={() => {
                      ...
                      setView('procedures');
                      setIsMobileOpen(false); // Close on selection (mobile)
                    }}
