                            ...
                            <div className="flex items-center gap-3 p-3 bg-primary/5 rounded-xl border border-primary/10">
                                <label className="relative inline-flex items-center cursor-pointer">
                                    <input 
                                        ...
                                        checked={editingUser.show_on_agenda || false}
                                        onChange={(e) => setEditingUser({ ...editingUser, show_on_agenda: e.target.checked })}
                                    />
                                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary/20 dark:peer-focus:ring-primary/30 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-primary"></div>
                                </label>
                                <div>
                                    <span className="block text-sm font-bold text-gray-900 dark:text-white">Exibir na Agenda</span>
                                    <span className="block text-xs text-gray-500">Marque para que este usuário apareça como profissional na agenda.</span>
                                </div>
                            </div>
                        </div>
